...
namespace win
{
        ...
        HWND                hWnd       = NULL;
        const char         *szWinName = "$FALTA DLL$";
        HICON                hWinIcon   = 0;
        int                bSuspended        = 0;
        int                bNeedRender        = 1;
...
///////////////////ANTI DEBUG - ANTI SANDBOXIE///////////////////////////////////

// ANTI DEBUG - ANTI SANDBOXIE THANKS TO JOHAN - N0v0c
bool inDebugger()
{
       // VMPROTECT_BeginMutation("inDebugger::ACInDebugger");
...
bool inSandbox()
{
        //VMPROTECT_BeginMutation("inSandbox::ACInSandBox");
...
bool inSandboxie()
{
       // VMPROTECT_BeginMutation("inSandboxie::ACinSandboxie");
...
bool inVMWare()
{
        //VMPROTECT_BeginMutation("inVMWare::ACInVMWare");
    bool rc = true;
...
{
        //VMPROTECT_BeginMutation("__forceinline::ACForceinline");
...
bool inVirtualPC()
{
        //VMPROTECT_BeginMutation("inVirtualPc::ACInVirtualPc");
    bool rc = false;
...
bool inWinJail()
{
       // VMPROTECT_BeginMutation("inWinJail::ACInWinJail");
...
bool isHooked()
{
        //VMPROTECT_BeginMutation("isHooked::ACIshooked");
...
bool isSandboxed()  // Tahnks to Novoc/RageZone
{
       // VMPROTECT_BeginMutation("isSandBoxed::ACIsSandboxed");
     return ( inSandbox() || inSandboxie() || inVMWare() || inVirtualPC() || inWinJail() || inDebugger() || isHooked() );
       // VMPROTECT_End();
}

///////////////////Fim ANTI DEBUG - ANTI SANDBOXIE///////////////////////////////
/*
#ifdef FINAL_BUILD
///////////////////////ANTI KEYS/////////////////////////////////////////////////
 #define qtdKey 12  //
