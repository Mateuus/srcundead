...
REG_VAR( g_serverip,			"198.50.211.32",	0 ); // 66.180.197.56 - IP of dev server where we host dev master\supervisor
REG_VAR( g_api_ip,				"198.50.211.32", 0);	// ipexterno
...
REG_VAR_C( r_grass_ssao,                1,        1,        1,    VF_CONSTRAINT );
