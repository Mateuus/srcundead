...
//original 0x0000004A //autual 7de 2014
#define P2PNET_VERSION		(0x000007DE + GBWEAPINFO_VERSION + GBGAMEINFO_VERSION + GAMEPLAYPARAM_VERSION)
...
enum pkttype_e
{
  ...
  PKT_S2C_SendGroupAccept,
  PKT_S2C_SendGroupNoAccept,
  PKT_S2C_SendGroupData,
  PKT_S2C_ReceivedGroupInvite,
  PKT_S2C_GetCustomerID,
};
...
struct PKT_S2C_SendGroupInvite_s : public DefaultPacketMixin<PKT_S2C_SendGroupInvite>
{
	//BYTE		peerId;
	DWORD		FromCustomerID;
	char		intogamertag[128];
	char		fromgamertag[128]; // actual text
};
struct  PKT_S2C_SendGroupAccept_s : public DefaultPacketMixin<PKT_S2C_SendGroupAccept>
{
	//BYTE		peerId;
	DWORD		FromCustomerID;
	char		intogamertag[128];
...
struct  PKT_S2C_SendGroupNoAccept_s : public DefaultPacketMixin<PKT_S2C_SendGroupNoAccept>
{
	//BYTE		peerId;
	DWORD		FromCustomerID;
	char		intogamertag[128];
...
struct PKT_S2C_SendGroupData_s : public DefaultPacketMixin<PKT_S2C_SendGroupData>
{
	int		peerid;
	int		ShowCustomerID;
	int		MeCustomerID;
...
struct PKT_S2C_ReceivedGroupInvite_s : public DefaultPacketMixin<PKT_S2C_ReceivedGroupInvite>
{
	BYTE	status;
	int		peerId;
	char	text[128];
};
struct PKT_S2C_GetCustomerID_s : public DefaultPacketMixin<PKT_S2C_GetCustomerID>
{
	int		CustomerID;
	char	gamertag[128];
